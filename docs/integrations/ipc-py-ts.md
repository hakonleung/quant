...
| screen     | `screen_run`                                                                    | 执行 ScreenPlan → 命中 RecordBatch（NL→DSL 已迁到 NestJS，本 op 现在只接 AST）                                                                                                                                                                |
| screen     | `nl_to_dsl` _(legacy)_                                                          | NL→DSL 已迁到 NestJS；op 暂留待清理                                                                                                                                                                                                           |
| screen     | `nl_screen` _(legacy)_                                                          | 旧合并 op，已弃用；同上待清理                                                                                                                                                                                                                 |
| pattern    | `find_similar_patterns`                                                         | DTW + similarity rank（始终全宇宙）                                                                                                                                                                                                           |
| sentiment  | `get_cached_stock_sentiment`                                                    | 仅读缓存（单股）                                                                                                                                                                                                                              |
| sentiment  | `analyze_one_stock_sentiment`                                                   | 强制刷新（paid，单股）                                                                                                                                                                                                                        |
| sentiment  | `get_cached_market_sentiment`                                                   | 仅读缓存（多股）                                                                                                                                                                                                                              |
| sentiment  | `analyze_many_stock_sentiment`                                                  | 强制刷新（paid，多股）                                                                                                                                                                                                                        |
...
| ledger     | `analyze_ledger` _(legacy)_                                                     | LLM 调用已迁到 NestJS（`apps/api/.../ledger.service.ts` 直接走 `LlmService.completeJson`）；Python op 暂留待清理                                                                                                                              |
