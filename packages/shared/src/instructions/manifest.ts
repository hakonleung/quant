...
const ENTRIES = [
  ...
  },
  {
    ...
    group: 'ui',
    mode: 'sync',
    summary: 'Switch the workbench theme (light / dark / toggle)',
    aliases: ['主题'],
    positional: ['mode'],
    examples: ['theme', 'theme light', 'theme dark', 'theme toggle'],
    argsSchema: ThemeArgsSchema,
    resultSchema: ThemeResultSchema,
  },
  {
    id: 'cache',
    group: 'ui',
